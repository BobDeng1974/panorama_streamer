...
String GetDisplayDriverVersion()
{
    ...
    if (file)
    {
        ...
        while (status == 0)
        {
            ...
            OVR_UNUSED(status);                 // Prevent GCC compiler warning: "ignoring return value of ‚Äòint fscanf(FILE*, const char*, ...)"
...
    Œ¢√}ÒüUW‘Óã¬PrÅØÓXHXV7kÌŒ.Ê—iô|t2b¥≈X,Z»N;≤<√°h›O<Üe¸+eïŸÜ#∑=◊˝ÍØ*ñE –=aÎ¶TŒ∏<õá'!UC,@ˇˆ…(©öaáÈﬁ„Jrq∏ù|\n1tFˆ”&	¥ÖzÖ\ﬂ'}YË¨WY∆±8∆eGö™M1ßÂ#⁄/~J±ÆPßŸÀ—l<0Ø1_ÇÙ	Uò~ºo